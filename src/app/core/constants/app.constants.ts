...
export class Constants {
  ...
  public static APIRoutes = {
    ...
    createDiscountApi: 'cap/discount/create',
    updateDiscountApi: 'cap/discount/update/',
...
export class MessageConstant {
  public static errorMessage = {
    ...
    discountMaxPercentage: 'Please add maximum discount amount for percentage',
    discountPercentagecgreater: 'Discount Percentage cannot be greater than 100',
    discountCodeAlreadyExist: 'Discount coupon code already exist',
  ...
  public static successMessage = {
    ...
    discountPublishSuccessfully: 'Discount publish successfully',
    discountDraftedSuccessfully: 'Discount save as draft successfully',
